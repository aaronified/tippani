...
export const HELP = {
  ...
  search: {
    title: 'Search',
    entries: [
      { term: 'Keyboard', what: 'Press ? anywhere for the full list. / searches, N captures a quote, ⌘K or Ctrl-K opens the palette, and G then L, C, Q or S goes to the Library, the Catalogue, Quotes or Stats. In a quiz, 1 and 2 grade and Space reveals a flip card. Every shortcut is also written on the button that does the same thing, so you never have to memorise one to find it.' },
