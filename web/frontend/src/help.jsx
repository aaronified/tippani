...
export const HELP = {
  ...
  'movie-detail': {
    ...
    entries: [
      { term: 'Studio', what: 'A game credits its studio where a film credits its director — the same slot, with the studio’s logo in place of a face. Fetching a game pins its IGDB id and takes the developer; if IGDB flags no developer, the publisher is used rather than leaving it blank.' },
