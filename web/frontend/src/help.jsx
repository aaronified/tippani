...
export const HELP = {
  ...
  'book-detail': {
    ...
    entries: [
      ...
      { term: 'Share', icon: <IconShare />, what: 'A line as Markdown, WhatsApp, plain text, Reddit, or an image card. The image is drawn locally in whichever of the four skins you pick and never leaves the machine, and it can carry a portrait backdrop: the author’s photo bled in from the card’s edge and faded out before the words start. It rides the same Author tick as the small portrait disc, so turning the credit off takes both.' },
  ...
  'movie-detail': {
    ...
    entries: [
      ...
      { term: 'Share', icon: <IconShare />, what: 'The line as Markdown, WhatsApp, plain text, Reddit, or an image card. The image can carry a portrait backdrop — the actor’s photo bled in from the edge and faded out before the words. Two credited actors take a side each, with the line between them, which is the shape a scene has.' },
    ],
  },
  search: {
    title: 'Search',
  ...
  quotes: {
    ...
    entries: [
      ...
      { term: 'Share', icon: <IconShare />, what: 'The quote as Markdown, WhatsApp, plain text, Reddit, or an image card. The image can carry a portrait backdrop — the speaker’s photo bled in from the card’s edge and faded out before the words start. Two speakers take a side each with the words between them, which is the shape a conversation has.' },
