...
const SHELL_COMMON = [
  ...
  entry('common.help.topbar.help', { icon: <IconHelp /> }),
...
export const HELP = {
  ...
  anthologies: section('nav.tab.anthologies.label', [
    ...
    entry('anthologies.help.export', { icon: <IconExport /> }),
  ...
  metadata: section('nav.tab.metadata.label', [
    ...
    entry('metadata.help.metadata-sources', { more: true }),
    entry('metadata.help.igdb', { more: true }),
    entry('metadata.help.language-marks', { icon: <IconLanguages />, more: true }),
    entry('metadata.help.credit-separators', { more: true }),
    entry('metadata.help.colour-categories', { asset: <HelpSwatches />, more: true }),
  ]),
