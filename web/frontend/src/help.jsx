...
export const HELP = {
  ...
  settings: {
    ...
    entries: [
      ...
      { term: 'Type', what: 'Every face the app uses, each shown doing its own job — the quote face setting a quote, the label face setting a locator. Two alternates apiece, bundled with the app and free to use; nothing is fetched from anywhere. Bold, italic, small caps, all caps and lining figures are per role. There is no monospace switch: whether a face is monospaced is how it was drawn, so change the face instead.' },
