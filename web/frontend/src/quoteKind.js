...
// The seven, in the order the form offers them: the three commonest first, then
// the poem, the song and the proverb — the three whose line breaks and language
// matter more than their occasion — then the residual. Machine values on the wire, always: the words
// are this module's business and the server never sends prose.
export const QUOTE_KINDS = ['speech', 'letter', 'essay', 'poem', 'song', 'proverb', 'other']
