...
// ---- THE SHARE FORMATS, one drawing each ----
//
// The owner drew these and sent them in; they are theirs, not a pack's. Two are
// service marks (WhatsApp, Reddit) and three are file shapes (plain text, an
// image, markdown), and they share a frame on purpose: the share sheet offers all
// five as one row of equals, so a brand mark drawn at one weight beside a document
// outline drawn at another would make two of the five look like a different kind
// of choice.
//
// A DIFFERENT GEOMETRY FROM EVERY OTHER GLYPH HERE, and it is worth knowing why
// rather than discovering it. `iconStroke` is a 24-unit box drawn in strokes and
// `iconFill` a 256-unit box drawn in fills; these are a 1088-unit box, filled,
// with the y axis flipped by a transform — which is how they were authored. They
// are NOT renormalised, because rewriting somebody's path data to fit a house
// viewBox is how a curve quietly changes shape. `fill: currentColor` is the only
// thing that matters for theming, and they have it.
const drawnGlyph = { viewBox: "-32 -32 1088 1088", fill: "currentColor", stroke: "none", "aria-hidden": "true" };
const DrawnMark = ({ size, d }) => (
  <svg {...drawnGlyph} width={size} height={size}>
    <g transform="translate(0, 960) scale(1, -1)"><path d={d} /></g>
  </svg>
);
export function IconShareWhatsApp({ size = ICON_SIZE }) { return <DrawnMark size={size} d="M519.892 938.667c0.002 0 0.003 0 0.005 0 278.741 0 504.705-225.964 504.705-504.705s-225.964-504.705-504.705-504.705c-80.993 0-157.53 19.078-225.362 52.985l2.92-1.322-297.455-66.254 66.254 297.5c-32.388 64.745-51.346 141.056-51.346 221.795 0 278.629 225.783 504.524 504.37 504.705h0.017zM519.892 21.022c228.061 0 412.94 184.88 412.94 412.94s-184.88 412.94-412.94 412.94v0h-0.596c-227.922-0.183-412.619-184.992-412.619-412.94 0-71.039 17.938-137.888 49.533-196.265l-1.081 2.183 7.984-14.958-42.166-189.31 189.31 42.166 15.003-8.029c56.304-30.621 123.286-48.654 194.473-48.727h0.022zM592.707 125.542c-103.538 4.972-195.143 52.228-258.595 124.742l-0.364 0.425c-127.415 128.746-133.93 245.975-117 321.68 12.006 53.161 36.991 99.276 71.474 136.459l-0.173-0.188 32.439 32.439 187.062-187.062-17.068-34.182c-5.575-10.74-8.844-23.449-8.844-36.921 0-22.742 9.317-43.309 24.341-58.091l0.424-0.424c14.816-15.003 35.384-24.296 58.122-24.296 13.407 0 26.060 3.231 37.222 8.956l-0.46-0.214 8.213 4.129 36.706 2.615 178.482-178.482-32.439-32.439c-52.433-48.24-122.401-78.137-199.339-79.145l-0.203-0.002zM326.59 605.47c-9.135-16.384-16.361-35.373-20.677-55.442l-0.245-1.36c-15.554-76.44 15.875-154.99 93.462-233.403 47.444-55.686 115.746-92.377 192.677-97.907l0.9-0.052c35.442 0.346 68.602 9.798 97.349 26.123l-0.996-0.521-73.412 73.412c-15.296-4.899-32.893-7.733-51.148-7.754h-0.011c-96.331 0.549-174.211 78.768-174.211 175.176 0 18.001 2.715 35.368 7.758 51.714l-0.33-1.241z" /> }
-54.762s-24.518-54.762-54.762-54.762c-30.244 0-54.762 24.518-54.762 54.762v0c0.025 30.234 24.528 54.736 54.759 54.762h0.003zM534.127 576.794l-65.491 13.357 49.33 244.87 244.87-48.974-13.045-65.491-179.69 35.617zM841.55 871.884c65.406 0 118.428-53.022 118.428-118.428s-53.022-118.428-118.428-118.428c-65.406 0-118.428 53.022-118.428 118.428v0c0.076 65.375 53.053 118.352 118.421 118.428h0.007zM841.55 701.811c28.523 0 51.645 23.122 51.645 51.645s-23.122 51.645-51.645 51.645c-28.523 0-51.645-23.122-51.645-51.645v0c0.025-28.513 23.133-51.62 51.643-51.645h0.003z" /> }
export function IconSharePlain({ size = ICON_SIZE }) { return <DrawnMark size={size} d="M642.003 746.333c0.15 0 0.327 0.001 0.504 0.001 58.379 0 111.269-23.496 149.731-61.548l-0.019 0.019c39.353-38.945 63.771-92.916 63.933-152.59v-255.14c-0.127-118.466-96.128-214.468-214.582-214.595h-66.795l-148.035-145.497-145.542 145.497h-66.605c-118.466 0.127-214.468 96.128-214.595 214.582v255.122c0 118.272 95.878 214.15 214.15 214.15h427.854zM641.558 151.523c69.31 0.076 125.475 56.242 125.551 125.544v255.117c-0.132 34.837-14.391 66.318-37.343 89.033l-0.011 0.011c-22.462 22.3-53.406 36.081-87.569 36.081-0.753 0-1.505-0.007-2.255-0.020l0.113 0.002h-425.895c-69.094 0-125.106-56.012-125.106-125.106v0-255.11c0.076-69.31 56.242-125.475 125.544-125.551h103.476l109.345-109.167 111.082 109.167zM809.405 232.552v89.043c0.001 0 0.001 0 0.002 0 69.34 0 125.551 56.211 125.551 125.551 0 0.235-0.001 0.47-0.002 0.704v-0.036 253.997c0 69.34-56.211 125.551-125.551 125.551v0h-424.737c-69.34 0-125.551-56.211-125.551-125.551v0h-89.043c0 118.517 96.077 214.595 214.595 214.595v0h424.737c118.517 0 214.595-96.077 214.595-214.595v0-253.774c0.002-0.304 0.002-0.664 0.002-1.024 0-118.517-96.077-214.595-214.595-214.595-0.001 0-0.002 0-0.003 0v0z" /> }
export function IconShareImage({ size = ICON_SIZE }) { return <DrawnMark size={size} d="M214.595 916.406h594.81c118.466-0.127 214.468-96.128 214.595-214.582v-424.749c-0.127-118.466-96.128-214.468-214.582-214.595h-151.653l-145.764-145.764-145.764 145.764h-151.641c-118.466 0.127-214.468 96.128-214.595 214.582v424.749c0.127 118.466 96.128 214.468 214.582 214.595h0.012zM809.405 151.523c69.31 0.076 125.475 56.242 125.551 125.544v424.744c-0.076 69.31-56.242 125.475-125.544 125.551h-594.818c-69.31-0.076-125.475-56.242-125.551-125.544v-424.744c0.076-69.31 56.242-125.475 125.544-125.551h188.512l108.9-108.9 108.9 108.9zM767.11 319.37h-328.125l35.617 56.097 128.223 199.012zM474.602 375.467l-35.617-56.097h-182.094l127.777 191.443zM469.259 638.145c0-35.162-28.504-63.666-63.666-63.666s-63.666 28.504-63.666 63.666c0 35.162 28.504 63.666 63.666 63.666s63.666-28.504 63.666-63.666z" /> }
export function IconShareMarkdown({ size = ICON_SIZE }) { return <DrawnMark size={size} d="M809.405 614.994h-594.81v89.043h594.81zM809.405 274.848h-594.81v89.043h594.81zM809.405 444.921h-594.81v89.043h594.81zM214.595 916.406h594.81c118.466-0.127 214.468-96.128 214.595-214.582v-424.749c-0.127-118.466-96.128-214.468-214.582-214.595h-151.653l-145.764-145.764-145.764 145.764h-151.641c-118.466 0.127-214.468 96.128-214.595 214.582v424.749c0.127 118.466 96.128 214.468 214.582 214.595h0.012zM809.405 151.523c69.31 0.076 125.475 56.242 125.551 125.544v424.744c-0.076 69.31-56.242 125.475-125.544 125.551h-594.818c-69.31-0.076-125.475-56.242-125.551-125.544v-424.744c0.076-69.31 56.242-125.475 125.544-125.551h188.512l108.9-108.9 108.9 108.9z" /> }
...
const tracedFill = { width: ICON_SIZE, height: ICON_SIZE, viewBox: "0 0 24 24", fill: "currentColor", fillRule: "evenodd", stroke: "none", "aria-hidden": "true" }
const tracedStroke = { width: ICON_SIZE, height: ICON_SIZE, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: 1.1, strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": "true" }
...
// IconTour — a plane, banking: the per-screen "Tour this page" button in each
// screen's help (help.jsx, tourLead) is what draws it. The owner's pick at 3.0.3,
// Tabler's plane-tilt in the app's own stroke, in place of IconReading, the open
// book that button wore. It was a pennant on a pole, drawn only by Settings'
// tour-replay card (OnboardingCard), which 3ae85d7f deleted. Not a circular
// arrow, because IconRefresh means the narrower thing, from the beginning.
// ---- the three verbs, and the eight roles -----------------------------------
//
// THE VERBS WERE ONE CIRCULAR ARROW DOING THREE JOBS. `IconRefresh` sat on every
// fetch, every reset and every check-for-updates in the app, and the owner named
// the defect: "it is not just this row that uses refresh as fetch. all popups use
// that for fetch. even the update uses a refresh icon." Three questions with one
// picture between them means the picture answers none of them — a reader pressing
// it cannot tell whether the row is about to go and ask a provider, throw away
// what is stored, or install a release.
//
// So there are three now, drawn by the owner and vendored as given: arrows coming
// DOWN for fetch, a circle turning back for reset, and a square being replaced for
// update. They share the share sheet’s geometry because they share its author.
export function IconFetch({ size = ICON_SIZE }) { return <DrawnMark size={size} d="M551.424 183.234h-93.091v755.433h93.091zM504.879-104.603l-388.515 388.515 65.815 65.815 322.7-322.7 322.7 322.7 65.815-65.815zM504.879 117.419l-388.515 388.375 65.815 65.955 322.7-322.7 322.7 322.7 65.815-65.955z" /> }
...
// director wore the reel that also means the catalogue. The owner chose the set
// themselves, from the packs, after rejecting what this session drew: "show me the
// set first. i do not trust you with designs", and then "dont draw stuff yourself.
// just fetch from the icon sources".
//
// So each one below names where it came from. Four are vendored unchanged from
// Phosphor and Tabler; three were sent as drawings and traced to vector here; one
// is the app’s own highlighter, which the owner kept.
//
// THE GEOMETRY VARIES BECAUSE THE SOURCES DO, and normalising them would be the
// same mistake the note above DrawnMark describes: Tabler is a 24-unit box drawn
// in strokes, Phosphor a 256-unit box drawn in fills, and a traced drawing is its
// own ink. Only `currentColor` has to be shared, and it is.

// Author — phosphor/pen-nib. A fountain pen, the owner’s own choice for the
// role: "author: fountain pen".
export function IconRoleAuthor({ size = ICON_SIZE }) { return <svg {...iconFill} width={size} height={size}><path d="M248,92.68a15.86,15.86,0,0,0-4.69-11.31L174.63,12.68a16,16,0,0,0-22.63,0L123.57,41.11l-58,21.77A16.06,16.06,0,0,0,55.35,75.23L32.11,214.68A8,8,0,0,0,40,224a8.4,8.4,0,0,0,1.32-.11l139.44-23.24a16,16,0,0,0,12.35-10.17l21.77-58L243.31,104A15.87,15.87,0,0,0,248,92.68Zm-69.87,92.19L63.32,204l47.37-47.37a28,28,0,1,0-11.32-11.32L52,192.7,71.13,77.86,126,57.29,198.7,130ZM112,132a12,12,0,1,1,12,12A12,12,0,0,1,112,132Zm96-15.32L139.31,48l24-24L232,92.68Z"/></svg> }
// Director — phosphor/film-slate. "the director cut board". NOT IconReel, which
// is the catalogue’s own glyph and would make a director and a shelf of films the
// same picture on a screen that shows both.
export function IconRoleDirector({ size = ICON_SIZE }) { return <svg {...iconFill} width={size} height={size}><path d="M216,104H102.09L210,75.51a8,8,0,0,0,5.68-9.84l-8.16-30a15.93,15.93,0,0,0-19.42-11.13L35.81,64.74a15.75,15.75,0,0,0-9.7,7.4,15.51,15.51,0,0,0-1.55,12L32,111.56c0,.14,0,.29,0,.44v88a16,16,0,0,0,16,16H208a16,16,0,0,0,16-16V112A8,8,0,0,0,216,104ZM192.16,40l6,22.07-22.62,6L147.42,51.83Zm-66.69,17.6,28.12,16.24-36.94,9.75L88.53,67.37Zm-79.4,44.62-6-22.08,26.5-7L94.69,89.4ZM208,200H48V120H208v80Z"/></svg> }
// Publisher — tabler/news, and it is a SUBSTITUTE, which is worth saying rather
// than burying. The owner asked for a typewriter; no pack surveyed has one at this
// weight, so this is the thing a publisher puts out rather than the thing they
// type on. It replaces the company mark publisher used to share with studio, which
// is the confusion that mattered.
export function IconRolePublisher({ size = ICON_SIZE }) { return <svg {...iconStroke} width={size} height={size}><path d="M16 6h3a1 1 0 0 1 1 1v11a2 2 0 0 1 -4 0v-13a1 1 0 0 0 -1 -1h-10a1 1 0 0 0 -1 1v12a3 3 0 0 0 3 3h11" /><path d="M8 8l4 0" /><path d="M8 12l4 0" /><path d="M8 16l4 0" /></svg> }
// Speaker — tabler/microphone-2. "speaker: mic".
export function IconRoleSpeaker({ size = ICON_SIZE }) { return <svg {...iconStroke} width={size} height={size}><path d="M15 12.9a5 5 0 1 0 -3.902 -3.9" /><path d="M15 12.9l-3.902 -3.899l-7.513 8.584a2 2 0 1 0 2.827 2.83l8.588 -7.515z" /></svg> }
// Actor — the owner’s drawing, traced. "actor: person, with a mask"; what they
// sent was the pair of theatre masks, and the trace is the drawing, not a redraw.
export function IconRoleActor({ size = ICON_SIZE }) { return <svg {...tracedFill} width={size} height={size}><path d="M11.81 22.69C11.46 22.65 11.24 22.62 11.10 22.57C10.82 22.48 10.20 21.67 9.82 20.91C9.14 19.55 8.87 17.96 9.01 16.16L9.02 15.96L8.72 15.85C7.07 15.24 5.52 14.02 4.21 12.29C3.22 10.98 2.35 9.32 1.64 7.44C1.43 6.88 1.27 6.39 1.27 6.32C1.27 6.21 1.42 5.78 1.55 5.53C2.01 4.61 2.95 3.71 4.20 2.99C5.71 2.12 7.65 1.49 9.37 1.32C9.75 1.28 10.65 1.28 10.97 1.32C11.79 1.42 12.49 1.66 13.01 2.01C13.33 2.22 13.36 2.25 13.54 2.82C13.91 3.97 14.15 4.95 14.32 5.98C14.43 6.67 14.48 7.07 14.55 8.04C14.56 8.20 14.57 8.22 14.61 8.23C14.64 8.23 14.82 8.27 15.00 8.30C16.07 8.50 17.29 8.99 18.58 9.73C20.93 11.07 22.45 12.80 22.69 14.41C22.75 14.81 22.75 14.82 22.54 15.18C20.80 18.16 18.83 20.28 16.65 21.53C15.57 22.15 14.47 22.53 13.33 22.67C12.92 22.72 12.17 22.73 11.81 22.69ZM12.95 21.86C13.30 21.83 13.69 21.76 14.07 21.67C16.82 20.97 19.39 18.72 21.58 15.09L21.86 14.62L21.82 14.42C21.76 14.09 21.57 13.64 21.35 13.29C21.04 12.79 20.50 12.17 19.97 11.73C18.67 10.62 16.72 9.60 15.21 9.21C14.58 9.05 14.09 9.00 13.49 9.02C12.92 9.03 12.39 9.15 12.24 9.28C12.18 9.34 11.70 10.24 11.51 10.67C11.44 10.82 11.32 11.06 11.25 11.21C11.02 11.69 10.68 12.56 10.45 13.30C10.22 14.02 9.97 15.11 9.93 15.59C9.93 15.64 9.91 15.75 9.90 15.84C9.79 16.61 9.81 17.82 9.96 18.62C10.17 19.80 10.70 20.97 11.28 21.59C11.45 21.78 11.46 21.79 11.61 21.81C11.99 21.88 12.49 21.90 12.95 21.86ZM13.39 20.12C12.43 19.94 11.72 19.28 11.39 18.26C11.23 17.74 11.16 17.15 11.18 16.42C11.20 15.71 11.32 14.93 11.43 14.74C11.53 14.56 11.79 14.48 11.97 14.57C12.01 14.60 12.23 14.80 12.46 15.02C13.23 15.80 13.90 16.36 14.37 16.63C14.79 16.87 15.90 17.24 17.05 17.53C17.46 17.62 17.56 17.68 17.63 17.84C17.70 18.03 17.65 18.19 17.45 18.38C16.94 18.87 16.24 19.36 15.58 19.69C14.93 20.01 14.49 20.13 13.92 20.15C13.68 20.15 13.51 20.14 13.39 20.12ZM14.29 19.26C14.69 19.18 15.31 18.92 15.71 18.65C15.90 18.52 16.24 18.24 16.24 18.22C16.24 18.21 16.10 18.16 15.93 18.12C14.65 17.78 13.87 17.41 13.11 16.80C12.87 16.61 12.39 16.18 12.23 16.01C12.18 15.97 12.14 15
// Translator — the owner’s drawing, traced: two letterforms from two scripts
// with arrows turning between them. "translator: the same glyph, but with two
// arrows (look it up)", then "the arrows need to be closer in translate".
export function IconRoleTranslator({ size = ICON_SIZE }) { return <svg {...tracedFill} width={size} height={size}><path d="M13.87 20.94C13.76 20.90 13.64 20.80 13.58 20.69C13.53 20.62 13.53 20.59 13.53 20.45C13.53 20.32 13.54 20.28 13.58 20.20C13.66 20.05 13.73 20.00 14.04 19.89C14.38 19.78 14.65 19.67 14.95 19.52C15.29 19.36 15.64 19.15 15.64 19.12C15.64 19.11 15.59 19.06 15.54 19.01C15.41 18.88 15.15 18.58 15.01 18.39C14.23 17.38 13.73 16.09 13.56 14.75L13.53 14.49L13.29 14.48C13.08 14.48 13.04 14.47 12.95 14.43C12.54 14.24 12.54 13.67 12.96 13.48L13.05 13.44L14.51 13.43L15.97 13.43L15.97 12.77L15.98 12.12L16.03 12.03C16.12 11.86 16.27 11.76 16.46 11.75C16.67 11.73 16.86 11.84 16.96 12.03L17.00 12.12L17.01 12.77L17.01 13.43L18.47 13.43L19.93 13.44L20.03 13.48C20.24 13.58 20.35 13.77 20.34 13.99C20.32 14.20 20.22 14.34 20.03 14.43C19.94 14.47 19.90 14.48 19.69 14.48L19.45 14.49L19.44 14.61C19.27 16.24 18.56 17.85 17.52 18.92C17.42 19.03 17.34 19.12 17.35 19.13C17.37 19.16 17.61 19.30 17.84 19.43C18.17 19.60 18.56 19.77 18.97 19.90C19.07 19.93 19.18 19.98 19.22 20.00C19.52 20.18 19.55 20.61 19.28 20.84C19.12 20.98 18.94 21.00 18.65 20.90C17.90 20.65 17.33 20.38 16.75 20.00C16.62 19.91 16.50 19.84 16.49 19.84C16.48 19.84 16.37 19.91 16.23 20.00C15.66 20.37 15.07 20.65 14.34 20.90C14.12 20.97 14.01 20.98 13.87 20.94ZM10.22 20.41C9.49 20.26 8.95 20.07 8.34 19.77C7.05 19.13 6.06 18.13 5.38 16.78C5.24 16.48 5.03 15.97 4.94 15.67C4.90 15.56 4.87 15.48 4.86 15.48C4.86 15.48 4.60 15.80 4.29 16.21C3.98 16.61 3.72 16.94 3.72 16.93C3.71 16.92 3.53 15.55 3.53 15.49C3.53 15.46 3.72 15.19 4.25 14.50C4.65 13.99 5.00 13.54 5.02 13.51L5.06 13.46L6.06 14.23L7.05 15.00L7.15 15.73C7.20 16.14 7.24 16.47 7.24 16.48C7.23 16.48 6.96 16.27 6.62 16.01C6.29 15.76 6.01 15.55 6.01 15.55C5.99 15.57 6.20 16.06 6.34 16.34C6.91 17.47 7.74 18.30 8.83 18.84C9.35 19.10 9.90 19.28 10.47 19.39C10.77 19.45 10.85 19.47 10.95 19.56C11.07 19.66 11.12 19.79 11.12 19.95C11.12 20.05 11.11 20.10 11.07 20.17C10.98 20.36 10.80 20.47 10.59 20.47C10.55 20.47 10.38 20.44 10.22 20.41ZM16.95 17.98C17.56 17.26 17.98 16.42 18.23 15.45C18.28 15.24 18.36 14.81 18.38 14.62L18.40 14.49L16.49 14.49L14.59 14.49L14.59 14.55C14.79 16.06 15.34 17.29 16.29 18.27L16.49 18.48L16.63 18.33C16.71 18.26 16.86 18.10 16.95 17.98ZM5.54 7.67C6.27 5.97 6.87 4.57 6.88 4.55C6.90 4.52 6.95 4.52 7.51 4.52C7.97 4.52 8.12 4.52 8.14 4.54C8.14 4.55 8.23 4.75 8.33 4.98C8.51 5.42 9.08 6.75 10.15 9.26C10.48 10.05 10.77 10.70 10.78 10.72C10.79 10.76 10.77 10.76 10.08 10.75L9.36 10.75L9.09 10.07L8.81 9.38L7.49 9.38L6.17 9.38L5.90 10.07L5.62 10.75L4.93 10.75L4.23 10.76L5.54 7.67ZM18.04 9.88C17.51 9.48 17.06 9.13 17.05 9.12C17.03 9.10 16.99 8.86 16.93 8.36C16.88 7.95 16.84 7.62 16.84 7.61C16.84 7.61 17.12 7.82 17.45 8.08C17.79 8.34 18.07 8.55 18.07 8.54C18.07 8.53 18.04 8.43 17.99 8.31C17.52 7.14 16.81 6.24 15.86 5.60C15.19 5.15 14.47 4.87 13.52 4.69C13.26 4.64 13.18 4.60 13.08 4.49C12.82 4.19 12.97 3.74 13.36 3.65C13.47 3.62 13.48 3.62 13.73 3.67C14.78 3.87 15.60 4.19 16.39 4.70C17.67 5.53 18.60 6.78 19.13 8.40C19.18 8.53 19.22 8.63 19.23 8.62C19.23 8.61 19.49 8.28 19.80 7.88C20.26 7.27 20.36 7.16 20.37 7.19C20.37 7.22 20.42 7.55 20.47 7.94L20.56 8.64L20.07 9.27C19.80 9.62 19.46 10.07 19.31 10.27C19.16 10.46 19.03 10.63 19.02 10.63C19.01 10.63 18.57 10.29 18.04 9.88ZM8.30 8.16C8.30 8.15 7.65 6.54 7.53 6.25C7.51 6.21 7.49 6.19 7.48 6.19C7.47 6.21 6.70 8.09 6.68 8.14C6.67 8.17 6.72 8.18 7.49 8.18C7.95 8.18 8.30 8.17 8.30 8.16Z"/></svg> }
// Studio — the owner’s drawing, traced, and the ONE of the three that is
...
export function IconTour({ size = ICON_SIZE }) { return <svg {...iconStroke} width={size} height={size}><path d="M14.5 6.5l3 -2.9a2.05 2.05 0 0 1 2.9 2.9l-2.9 3l2.5 7.5l-2.5 2.55l-3.5 -6.55l-3 3v3l-2 2l-1.5 -4.5l-4.5 -1.5l2 -2h3l3 -3l-6.5 -3.5l2.5 -2.5l7.5 2.5"/></svg> }
...
export function SheetFooter({ count, onReset, onDone }) {
  return (
    <>
      ...
      {onReset && (
        <GhostButton icon={<IconReset />} keepLabel className="tp-btn-danger" onClick={onReset}>
