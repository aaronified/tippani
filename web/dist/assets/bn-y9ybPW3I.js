...
home.help.status-dot.what = প্রতিটা উদ্ধৃতির গায়ে একটা থাকে: মনে আছে, ভুলছেন, সম্ভবত ভুলে গেছেন, বা এখনও অনুশীলনে ওঠেনি। মাউস রাখলে বা ট্যাপ করলে স্মৃতির অর্ধায়ু দেখায়।
...
common.help.cover-menu.what = বোর্ডে বই, সিনেমা বা শোয়ে ডান-ক্লিক করুন — ফোনে চেপে ধরুন — মেনুতে থাকে বাছুন, শূন্যস্থান পূরণ, অনুশীলনীর সুইচ, এডিট আর মুছুন।
...
identity.section.links.note.character = এই চরিত্র নিয়ে অ্যাপের বাইরে কোথায় লেখা আছে।
identity.section.links.note.person = এঁকে নিয়ে অ্যাপের বাইরে কোথায় লেখা আছে।
identity.section.links.note.company = এই সংস্থাটিকে নিয়ে অ্যাপের বাইরে কোথায় লেখা আছে।
...
identity.row.canonical.empty = এখনও নাম নেই
...
identity.link.id.title = আইডি থেকে লিঙ্ক যোগ করুন
...
identity.link.id.hint.imdb = nm দিয়ে শুরু — তাঁর IMDb পাতার ঠিকানা থেকে
identity.link.id.hint.tmdb = তাঁর TMDB ঠিকানার সংখ্যাটা
identity.link.id.hint.tvdb = তাঁর TheTVDB ঠিকানার সংখ্যা বা স্লাগ
identity.link.id.hint.amazon = তাঁর অ্যামাজন লেখক-আইডি, B0 দিয়ে শুরু
identity.link.id.hint.igdb = সংস্থার IGDB স্লাগ, ঠিকানায় যেমন থাকে
...
identity.row.remove-all.sub = একটা একটা কাজ থেকে আলাদা করা হয় — একসঙ্গে কিছু মুছে যায় না
...
identity.field.links = লিংক, প্রতি লাইনে একটা
...
metadata.prune.tip = কোনও উৎসের সঙ্গে যোগ নেই এমন প্রতিটা সেভ করা মানুষ আর চরিত্র সরিয়ে দেয়
metadata.prune.confirm.title = {n}টা রেকর্ড সরাবেন?
metadata.prune.confirm.body = {people} আর {characters} — গ্রন্থাগারের কিছুই এদের দিকে তাকায় না। নাম, ছবি আর নোট ডাস্টবিনে যাবে, তাই এক এক করে ফিরিয়ে আনা যাবে।
...
bin.row.work.quotes.one = {n}টা উদ্ধৃতি
bin.row.work.quotes.other = {n}টা উদ্ধৃতি
`;export{e as default};
