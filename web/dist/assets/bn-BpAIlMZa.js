...
settings.appearance.colours.light.label = আলো
settings.appearance.colours.dark.label = অন্ধকার
settings.appearance.colours.accent.label = রং
...
metadata.characters.column.gap.one = {n}টা উপস্থিতিতে কোনও মুখ বাছা হয়নি
metadata.characters.column.gap.other = {n}টা উপস্থিতিতে কোনও মুখ বাছা হয়নি
...
metadata.characters.delete.confirm.body = রেকর্ডটা ঝুড়িতে যাবে, ফিরিয়ে আনা যাবে। যে কাজগুলোয় আছে সেগুলোর কাস্ট থাকবে, শুধু আর কোনও রেকর্ড দেখাবে না।
...
metadata.people.quotes.sub = {n}টি উদ্ধৃতি
