...
settings.keys.tvdb.hint = সিনেমা আর শোয়ের জন্য প্রথমে এটাই দেখা হয়, আর চরিত্রপিছু ছবি কেবল এখানেই আছে: thetvdb.com → Dashboard → API keys। প্রজেক্ট কি একাই চলে। কেবল ফ্রি (user-supported) কি হলে নিচের PIN-টাও লাগে।
settings.keys.tvdb-pin.hint = কেবল ফ্রি (user-supported) কি-র জন্য, যেটা এটা ছাড়া লগইনেই বাতিল হয় — তখন ফল চুপচাপ TMDB থেকে আসে। প্রজেক্ট কি, এমনকি অ্যাপের সঙ্গে আসা কি-টাও, PIN পাঠায়ই না। thetvdb.com → আপনার অ্যাকাউন্ট → Subscriber PIN।
...
links.empty = এখনও কোনও লিঙ্ক নেই। নিচে একটি বসান — যেকোনও সাইটের যেকোনও ঠিকানা।
links.paste.label = লিঙ্ক বসান
