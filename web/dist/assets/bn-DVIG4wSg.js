...
settings.quiz.tier.info.body = মাঝারি মানে অনুশীলনী চিরকাল যেমন ছিল তেমনই। সহজে চারটের বদলে দুটো উত্তর থাকে আর ভুল উত্তরগুলো দূরের হয়; কঠিনে মূলত টাইপ করতে হয়; এলোমেলো প্রতিটা কার্ডে আলাদা বাছে। কোনও ধাপ প্রশ্ন কমায়, শেষ করে না।
...
settings.quiz.tier.easy.note = কাছাকাছি ভুল উত্তর সহজ ভুল উত্তরের চেয়ে বেশি শেখায় — কোনটা কেন ভুল, সেটাও মনে থাকে, শুধু কোনটা ঠিক তা নয়। সহজ ধাপ ইচ্ছে করেই সেটা ছেড়ে দেয়, যাতে আর কিছুতে উত্তর না এলেও প্রশ্নটার উত্তর দেওয়া যায়।
