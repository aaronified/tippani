...
book.field.translator.info = বইটা এই ভাষায় কে এনেছেন। লেখকের মতোই তাঁর মুখের ছবি আর নিজের পাতা থাকে, নাম দেখা যায় এই বইয়ের পাতায় — কিন্তু গ্রন্থাগারের বোর্ডে বা উদ্ধৃতিতে নয়, সেখানে একটা নামই লাইনের সবটা।
...
home.help.practise.more = বই বা সিনেমার নিজের মেনুতে, মানুষের প্যানেলে, ট্যাগের পাশে, পরিসংখ্যানের রঙের সারিতে — যেখানেই জিনিসটার নাম আছে। রাউন্ডটা যে স্ক্রিনে ছিলেন তার উপরেই খোলে, শেষে সেখানেই ফেরায়। দৈনিক প্রশ্নোত্তরের এমন এক-বিষয়ের কোনও রূপ নেই, ইচ্ছে করেই: ওই ডেকটাই তো রুটিন, ছেঁকে নিলে যেগুলোর সত্যিই পালা সেগুলো না জিজ্ঞেস করেই দিনটা টানার হিসেবে উঠে যেত।
...
identity.lines.empty.character = গ্রন্থাগারে এখনও এদের নামে কিছু নেই।
