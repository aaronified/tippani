...
- **1,509 Go test functions and 3,626 frontend tests, across 562 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 311 frontend
  ```
