...
- **1,493 Go test functions and 3,250 frontend tests, across 529 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 280 frontend
  ```
  ...
  1,391 / 2,366 / 419, from 1,466 / 2,772 / 471, from 1,493 / 3,041 / 520, from 1,493 / 3,071 / 521, from 1,493 / 3,083 / 522, and from 1,493 / 3,111 / 523 before
