...
- **1,708 Go test functions and 4,209 frontend tests, across 639 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 364 frontend
  ```
