...
- **1,726 Go test functions and 4,336 frontend tests, across 650 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 375 frontend
  ```
