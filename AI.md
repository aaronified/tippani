...
- **1,710 Go test functions and 4,292 frontend tests, across 646 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 371 frontend
  ```
