...
- **1,708 Go test functions and 4,202 frontend tests, across 638 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 363 frontend
  ```
