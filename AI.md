...
- **1,713 Go test functions and 4,312 frontend tests, across 648 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 373 frontend
  ```
