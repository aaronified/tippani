...
- **1,522 Go test functions and 3,646 frontend tests, across 565 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 314 frontend
  ```
