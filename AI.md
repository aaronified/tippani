...
- **1,513 Go test functions and 3,642 frontend tests, across 564 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 313 frontend
  ```
