...
- **1,494 Go test functions and 3,562 frontend tests, across 551 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 302 frontend
  ```
