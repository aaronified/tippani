...
- **1,508 Go test functions and 3,624 frontend tests, across 561 test files** — the
  ...
  find ./web/frontend -path '*/node_modules' -prune -o \
       -type f \( -name '*.test.*' -o -name '*.spec.*' \) -print | wc -l # 310 frontend
  ```
