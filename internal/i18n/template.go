...
func Template() string {
	...
	say("#")
	say("# MAKE IT UNIQUE among the languages you install. Nothing here refuses a")
	say("# duplicate — two files claiming \"Français\" are both kept and the picker tells")
	say("# them apart by adding the code, \"Français (fr)\" and \"Français (fr-ca)\" —")
	say("# but a name of your own is better than a name with a code stapled to it.")
	say("#")
	say("# THE CODE IS THE FILE NAME, not a line in here, and there is no list of")
	say("# accepted languages: any name of lower-case letters, digits and hyphens is a")
	say("# code, so a language nobody has thought of needs no permission. It is also")
	say("# lower-cased, which means FR.txt and fr.txt are the SAME language — put both")
	say("# in this folder and only fr.txt is read, and the log says so.")
	say("_name =")
	say("")
