...
- **1,803 Go test functions and 4,782 frontend tests, across 790 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 106 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,782 is what
  ...
  `npm run journeys` runs 106 tests over 74 files against a real server in a real
