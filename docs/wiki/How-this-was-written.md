...
- **1,783 Go test functions and 4,782 frontend tests, across 783 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 101 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,782 is what
  ...
  `npm run journeys` runs 101 tests over 70 files against a real server in a real
