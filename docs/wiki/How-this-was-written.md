...
- **1,738 Go test functions and 4,499 frontend tests, across 701 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 47 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,452 is what
  ...
  `npm run journeys` runs 47 tests over 32 files against a real server in a real
