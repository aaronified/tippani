...
- **1,802 Go test functions and 4,782 frontend tests, across 789 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 105 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,782 is what
  ...
  `npm run journeys` runs 105 tests over 73 files against a real server in a real
