...
- **1,804 Go test functions and 4,785 frontend tests, across 792 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,785 of them
  cd web/frontend && npm run journeys                                    # + 109 in the browser
  ...
  find ./web/frontend -path '*/node_modules' -prune -o -type f \
       ...
       -print | wc -l                                                    # 500 frontend
  ```

  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,785 is what
  ...
  `npm run journeys` runs 109 tests over 76 files against a real server in a real
