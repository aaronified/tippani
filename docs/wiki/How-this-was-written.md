...
- **1,738 Go test functions and 4,551 frontend tests, across 708 test files** — the
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,452 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,712 tests over 311
