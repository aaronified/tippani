...
- **1,738 Go test functions and 4,485 frontend tests, across 698 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,440 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,440 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,630 tests over 308
