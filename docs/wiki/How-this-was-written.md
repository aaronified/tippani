...
- **1,738 Go test functions and 4,460 frontend tests, across 692 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 35 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,425 is what
  ...
  `npm run journeys` runs 35 tests over 27 files against a real server in a real
