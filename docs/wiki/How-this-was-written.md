...
- **1,751 Go test functions and 4,719 frontend tests, across 732 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,652 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,652 is what
