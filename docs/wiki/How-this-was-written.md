...
- **1,804 Go test functions and 4,784 frontend tests, across 792 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 108 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,784 is what
  ...
  `npm run journeys` runs 108 tests over 76 files against a real server in a real
