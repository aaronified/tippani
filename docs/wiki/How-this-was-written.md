...
## Measured as of `b90c541db7255c251646555aa91f34b01df1068b` (2026-09-26)

| Figure | Value |
| --- | --- |
| Commits, no merges, exclusions applied | 1,600 |
| AI-assisted commits | 1,588 — 99.2% |
| Lines added / removed, AI-assisted commits | +822,340 / -343,021 |
| Lines added / removed, all commits | +831,935 / -351,477 |
| **Surviving lines from AI-assisted commits** | **476,408 of 480,307 — 99.2%** |
...
- **Coverage.** Tracked files: 1,438 blamed, 4 removed by the exclusion list, 449 skipped as
...
exclusion list is not applied, so the rows sum to 1,598 against the block's 1,588. One
...
variant: 450 of the Opus 5 commits, 128 of the Opus 5.5 ones and 146 of the Opus 4.8
...
```bash
SHA=b90c541d   # the commit the block above is stamped with
...
- **1,828 Go test functions and 4,828 frontend tests, across 811 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,828 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,828 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,908 tests over 338
