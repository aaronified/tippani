...
- **1,751 Go test functions and 4,703 frontend tests, across 731 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,636 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,636 is what
