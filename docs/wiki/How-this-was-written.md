...
- **1,738 Go test functions and 4,635 frontend tests, across 716 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,580 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,580 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,769 tests over 317
