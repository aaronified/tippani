...
- **1,771 Go test functions and 4,823 frontend tests, across 759 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,823 of them
  cd web/frontend && npm run journeys                                    # + 79 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,744 is what
  ...
  `npm run journeys` runs 79 tests over 53 files against a real server in a real
