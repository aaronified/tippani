...
- **1,806 Go test functions and 4,794 frontend tests, across 797 test files** — the
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,794 is what
  ...
  1,738 / 4,455 / 681, from 1,738 / 4,470 / 695, from 1,804 / 4,784 / 792, from 1,804 / 4,787 / 794, from 1,805 / 4,787 / 796, from 1,806 / 4,789 / 796, and from 1,806 / 4,793 / 797 before the
