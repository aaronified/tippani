...
- **1,738 Go test functions and 4,498 frontend tests, across 700 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,452 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,452 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,642 tests over 309
