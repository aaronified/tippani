...
- **1,751 Go test functions and 4,698 frontend tests, across 730 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,633 of them
  ...
  find ./web/frontend -path '*/node_modules' -prune -o -type f \
       ...
       -print | wc -l                                                    # 445 frontend
  ```

  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,633 is what
