...
- **1,780 Go test functions and 4,771 frontend tests, across 770 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,771 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,771 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,858 tests over 330
