...
- **1,751 Go test functions and 4,708 frontend tests, across 731 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,641 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,641 is what
