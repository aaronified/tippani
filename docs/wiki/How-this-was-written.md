...
- **1,777 Go test functions and 4,776 frontend tests, across 770 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,776 of them
  ...
  find ./web/frontend -path '*/node_modules' -prune -o -type f \
       ...
       -print | wc -l                                                    # 481 frontend
  ```

  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,776 is what
