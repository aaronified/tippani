...
- **1,804 Go test functions and 4,787 frontend tests, across 794 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 110 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,787 is what
  ...
  `npm run journeys` runs 110 tests over 77 files against a real server in a real
  ...
  1,738 / 4,455 / 681, from 1,738 / 4,470 / 695, and from 1,804 / 4,784 / 792 before the
