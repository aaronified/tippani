...
- **1,746 Go test functions and 4,681 frontend tests, across 726 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 63 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,618 is what
  ...
  `npm run journeys` runs 63 tests over 43 files against a real server in a real
