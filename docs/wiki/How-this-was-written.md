...
- **1,738 Go test functions and 4,453 frontend tests, across 687 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 31 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,422 is what
  ...
  `npm run journeys` runs 31 tests over 23 files against a real server in a real
