...
- **1,803 Go test functions and 4,784 frontend tests, across 791 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 107 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,784 is what
  ...
  `npm run journeys` runs 107 tests over 75 files against a real server in a real
