...
- **1,819 Go test functions and 4,797 frontend tests, across 801 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,797 of them
  ...
  find ./web/frontend -path '*/node_modules' -prune -o -type f \
       ...
       -print | wc -l                                                    # 506 frontend
  ```

  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,797 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,881 tests over 333
  ...
  1,738 / 4,455 / 681, from 1,738 / 4,470 / 695, from 1,804 / 4,784 / 792, from 1,804 / 4,787 / 794, from 1,805 / 4,787 / 796, from 1,806 / 4,789 / 796, from 1,806 / 4,793 / 797, from 1,806 / 4,794 / 797, from 1,815 / 4,794 / 799, from 1,816 / 4,794 / 800, from 1,818 / 4,794 / 800, and from 1,818 / 4,797 / 801 before the
