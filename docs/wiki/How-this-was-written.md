...
- **1,805 Go test functions and 4,787 frontend tests, across 796 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,787 of them
  cd web/frontend && npm run journeys                                    # + 113 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,787 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,871 tests over 331
  files; `npm run lint:rules` runs the third, 916 assertions over 94 files; and
  `npm run journeys` runs 113 tests over 79 files against a real server in a real
  ...
  1,738 / 4,455 / 681, from 1,738 / 4,470 / 695, from 1,804 / 4,784 / 792, and from 1,804 / 4,787 / 794 before the
