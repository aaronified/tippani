...
- **1,783 Go test functions and 4,782 frontend tests, across 784 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 103 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,782 is what
  ...
  `npm run journeys` runs 103 tests over 71 files against a real server in a real
