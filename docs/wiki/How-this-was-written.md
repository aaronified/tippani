...
- **1,769 Go test functions and 4,696 frontend tests, across 747 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,696 of them
  cd web/frontend && npm run journeys                                    # + 72 in the browser
