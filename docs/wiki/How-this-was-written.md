...
- **1,774 Go test functions and 3,858 frontend tests, across 763 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 78 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,744 is what
  ...
  `npm run journeys` runs 78 tests over 56 files against a real server in a real
