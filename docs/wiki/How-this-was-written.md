...
- **1,751 Go test functions and 4,694 frontend tests, across 729 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,629 of them
  ...
  find ./web/frontend -path '*/node_modules' -prune -o -type f \
       ...
       -print | wc -l                                                    # 444 frontend
  ```

  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,629 is what
