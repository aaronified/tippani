...
- **1,771 Go test functions and 4,822 frontend tests, across 758 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,822 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,744 is what
  ...
  `npm run journeys` runs 78 tests over 52 files against a real server in a real
