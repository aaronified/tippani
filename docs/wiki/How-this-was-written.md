...
- **1,738 Go test functions and 4,501 frontend tests, across 703 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 49 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,452 is what
  ...
  `npm run journeys` runs 49 tests over 34 files against a real server in a real
