...
- **1,777 Go test functions and 4,758 frontend tests, across 766 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 83 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,758 is what
  ...
  `npm run journeys` runs 83 tests over 57 files against a real server in a real
