...
- **1,778 Go test functions and 4,767 frontend tests, across 769 test files** — the
  ...
  cd web/frontend && npx vitest run                                      # 4,767 of them
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,767 is what
  ...
  the binary and seeds a library. `npm test` runs two projects — 3,854 tests over 329
