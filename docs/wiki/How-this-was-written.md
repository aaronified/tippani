...
- **1,738 Go test functions and 4,470 frontend tests, across 694 test files** — the
  ...
  cd web/frontend && npm run journeys                                    # + 40 in the browser
  ...
  **`npm test` NO LONGER RUNS ALL OF THEM, AND THAT IS THE POINT.** 4,430 is what
  ...
  `npm run journeys` runs 40 tests over 28 files against a real server in a real
