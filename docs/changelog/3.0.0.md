...
entry written while 3.0 was being built, for anyone who wants the detail and the reasons. The newest
pass comes first, and it was corrected wherever it no longer matched what 3.0.0 does. The older
passes are kept as they were written. Where an older pass says something a newer one contradicts,
the newer one is what 3.0.0 does.
...
- **A deleted account is opaque in the admin's bin.** It shows the account's name and how many
  quotes it holds; expanding it is not offered and the server returns none of its contents.
...
- **Metadata and Settings sit further in from a phone's edge.** On a phone both screens keep
  ...
  than they did. On a desk Metadata's cards hold their content a little further from their
